    ...
    <div className='whole'>
      ...
      <nav className="main-nav">
        ...
        <div
          className={
            showMediaIcons ? "menu-link mobile-menu-link" : "menu-link"
          } id='navbar' style={{ marginTop: '10px' }}>
          <ul>
            <li style={{ fontSize: '14px' }}>
              <NavLink to="/"><a href='/' className='active'><FontAwesomeIcon icon={faHomeAlt} />&nbsp; FREE TRY AT HOME</a></NavLink>
            </li>
            <li style={{ fontSize: '14px' }}>
              <NavLink to="/"><a href='/'><FontAwesomeIcon icon={faStore} />&nbsp; FIND STORE</a></NavLink>
            </li>
            <li style={{ fontSize: '14px' }}>
              <NavLink to="/"><a href='/'><FontAwesomeIcon icon={faCalendarCheck} />&nbsp; PLAN OF PURCHASE</a></NavLink>
            </li>
            <li style={{ fontSize: '14px' }}>
              <NavLink to="/"><a href='/'><FontAwesomeIcon icon={faCoins} />&nbsp; BUY DIGITAL GOLD</a></NavLink>
            </li>
            <li style={{ fontSize: '12px' }}><form>
              <input style={{ borderRadius: '5px 0px 0px 5px', width: '200px', fontSize: "14px", padding: '6px 10px' }} type='text' placeholder="Search..." />
              <button style={{ backgroundColor: '#aa5af1', borderRadius: '0px 5px 5px 0px', padding: '10px 10px', marginTop: '5px' }} type='submit'><FaSearch /></button>
            </form>
            </li>
          </ul>
        </div>
        ...
        <div className="social-media" style={{ paddingTop: '10px' }}>
          <ul className="social-media-desktop">
            <li><Link style={{ fontSize: '14px' }} to='/'><LocationOnIcon /></Link></li>
            <li><Link to='/signup'><PersonIcon /></Link></li>
            <li><Link to='/wishlist'><FavoriteIcon /></Link></li>
            <li><Link to='/cart'><ShoppingBasketOutlinedIcon /></Link></li>
          </ul>
