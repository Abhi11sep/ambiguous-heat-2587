...
const CarouselCard = () => {
  ...
  return (
    <div style={{ marginTop: '80px' }}>
      ...
      <p style={{
        textAlign: 'left', marginLeft: "120px", fontSize: '24px',
        fontWeight: '400', color: '#33363E',marginBottom:'50px'
      }}>Best of Crystal & Gold</p>

      <div className="carousel-wrapper" style={{ width: '95%', margin: 'auto' }}>
          ...
          {items.map((item) => (
            <div >
              <img style={{
                ...
                borderRadius: '10px'
              }} src={item.pic} width='280px' />
              <p style={{
                padding: "2px 10px", textAlign: 'left', fontWeight: '400',
                fontSize: '18px', marginTop: '10px', lineHeight: '0px'
              }}> &#8377; {item.price} &nbsp; <strike style={{ fontSize: '14px' }}> &#8377; {item.strikeoff}</strike> </p>
              <p style={{
                padding: "2px 10px", textAlign: 'left', fontWeight: '400',
                fontSize: '16px', marginTop: '0px', lineHeight: '30px', color: 'grey'
              }}>{item.title}</p>
            </div>
          ))}
        </Carousel>
